...
if  ( ! function_exists( 'thumbs_rating_getlink' ) ):
	...
	function thumbs_rating_getlink($post_ID = '', $type_of_vote = '')
	{
		...
		$link_up = '<span class="thumbs-rating-up'. ( (isset($thumbs_rating_up_count) && intval($thumbs_rating_up_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 1);" data-text="' . __('&#128077;','thumbs-rating') . '">' . $thumbs_rating_up_count . '</span>';
		$link_down = '<span class="thumbs-rating-down'. ( (isset($thumbs_rating_down_count) && intval($thumbs_rating_down_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 2);" data-text="' . __('&#128078;','thumbs-rating') . '">' . $thumbs_rating_down_count . '</span>';
...
if  ( ! function_exists( 'thumbs_rating_getlink2' ) ):

	function thumbs_rating_getlink2($post_ID = '', $type_of_vote = '')
	{
		...
		$link_up = '<span class="thumbs-rating-up'. ( (isset($thumbs_rating_up_count) && intval($thumbs_rating_up_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 1);" data-text="' . __("Like &#128077;",'thumbs-rating') . '">' . $thumbs_rating_up_count . '</span>';
		$link_down = '<span class="thumbs-rating-down'. ( (isset($thumbs_rating_down_count) && intval($thumbs_rating_down_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 2);" data-text="' . __('Dislike &#128078;','thumbs-rating') . '">' . $thumbs_rating_down_count . '</span>';
